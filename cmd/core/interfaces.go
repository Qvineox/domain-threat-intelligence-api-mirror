...
type IBlacklistsService interface {
	...
	ImportFromSTIX2(bundles []blacklistEntities.STIX2Bundle, extractAll bool) (int64, []error)
	ImportFromCSV(data [][]string, discoveredAt time.Time, extractAll bool) (int64, []error)
